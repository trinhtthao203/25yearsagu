        ...
        <div className="w-full h-full">
            ...
            <div className="flex flex-col justify-center items-center bg[#f1f2f6] py-[6rem]">
                ...
                <p className=" max-w-[49rem] text-[0.9rem] sm:text-[0.5rem] lg:text-[1.2rem] text-justify  my-5 mx-[5rem] text-[#2C3A47]">
                    ...
                    veritatis dicta aspernatur deserunt libero placeat fugiat
                    laborum? Aliquid, deserunt quos repellat sunt nemo velit
                    repellendus. Iste temporibus provident dolore nobis
                    repudiandae blanditiis alias beatae pariatur, ipsa odit ad,
                    praesentium tempore! Lorem ipsum dolor, sit amet consectetur
                    adipisicing elit. Enim maiores iste numquam veritatis minima
                    amet, odit, saepe molestiae sunt perferendis, magnam magni
                    nihil. Ipsam, ea sapiente eveniet iste distinctio aperiam
                    eligendi nisi blanditiis totam repellat quae dolore natus!
                    Facilis vitae at natus voluptatibus id, doloribus molestias
                    nobis molestiae ea et accusamus eveniet explicabo enim
                    rerum. Quam facilis magni inventore praesentium, recusandae
                    corrupti in et incidunt eius ipsa iure? Facilis eos ut
                    distinctio dolorum eaque labore neque voluptatibus
                    ...
                    pariatur aspernatur nulla nesciunt dignissimos facere!
                    Assumenda sed et magni exercitationem itaque aut
                    perspiciatis accusamus nemo rerum culpa! Saepe voluptas
                    soluta asperiores ducimus amet voluptatem, sunt ipsam ea
                    incidunt cumque consequatur. Tenetur nemo cumque, amet illo
                    et animi dignissimos omnis, magni error officia molestiae
                    ipsam fuga dicta ea rem corrupti pariatur perspiciatis odit
                    nisi consequatur necessitatibus perferendis neque. Velit
                    autem quidem aliquid. Asperiores vitae adipisci eaque fuga
                    aut maxime, quos quidem sit totam et explicabo itaque
                    excepturi harum.
                </p>
                <img
                    src={`${HieuTruong}`}
